...
use Juo\AdminAPI\Utils\Retry\RetryConfig;
...
class SDKConfiguration
{
    ...
    public string $openapiDocVersion = '8.15.0';

    public string $sdkVersion = '0.0.1';

    public string $genVersion = '2.727.9';

    public string $userAgent = 'speakeasy-sdk/php 0.0.1 2.727.9 8.15.0 juo/admin-api';
    ...
    public function getServerUrl(): string
    {
        ...
        if (isset(Juo::SERVERS[$this->serverIndex])) {
            return Juo::SERVERS[$this->serverIndex];
        } else {
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(Juo::SERVERS[$this->serverIndex], []);
